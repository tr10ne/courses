...
const NotFound = () => {
  ...
  const NotFoundTitle = `404 страница не найдена | COURSES`;
  const NotFoundDescription = `Страница не найдена. Возможно она была удалена или был введен неверный адрес.`;

  return (
    <>
      <PageMetadata title={NotFoundTitle} description={NotFoundDescription} />
